...
<nav id="nav">
    ...
    <section class=" menu-area-azul" >
        ...
        <div class="row col-xl-12">
            ...
            </div class="textoprodutoh"> Mercado - Institucional 
        </div>
            </div>
     ...
     <div class="container-menus">
        <ul class="text-cente menu-linha">
           <li><a  href="<?php bloginfo('url'); ?>/alimentos-e-bebidas" >Alimentos e Bebidas</a></li>
            ...
            <li><a  href="<?php bloginfo('url'); ?>/Institucional" class="item active">Institucional</a></li>
...
$(document).ready(function() {
  ...
  $('.item').click(function() {
    ...
    <div class="row">
        ...
        $categoria_slug = 'institucional'; // Substitua 'nome-da-categoria' pela slug da categoria desejada
