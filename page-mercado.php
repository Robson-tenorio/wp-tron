...
<div class="heade textopesqueisa">
  ...
  <li>
    <label class="radio-label ">
      <a href="<?php bloginfo('url'); ?>/mercados">  <input type="radio" checked  style="pointer-events:none;"></a>
  ...
  <li>
    <label class="radio-label">
      <a href="<?php bloginfo('url'); ?>/produtos">  <input type="radio" style="pointer-events:none;"></a>
...
$(document).ready(function() {
  ...
  $('.item').click(function() {
    ...
    <?php if ($the_query->have_posts()) : while ($the_query->have_posts()) : $the_query->the_post(); ?>
        ...
        $category_detail = get_the_terms(get_the_ID(), 'mercado_categoria');
        ...
        ?>">
            ...
            <div class="product-list col-xl-12 col-sm-12 col-12">
                <div class="product efeito-suave">
                    <img class="img-produto card-img-top" id="imgs" src="<?php the_field('imgem_mercado'); ?>" class="rounded mx-auto d-block">
...
<script>
    ...
    $('.menus a').click(function() {
        $('.menus a').removeClass('active'); // Remove a classe de todos os links
