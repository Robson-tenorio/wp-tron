...
<section>
  ...
  <div class="row text-center">
        <div class="col-sm text-center">
          <h2 id="textoprodutoh56">Clique abaixo para realizar o <br>download do catálogo</h2>
   <a href="<?php the_field('donloado_do_catalogo'); ?>" target="_blank"><button class="botao-imagem-gradiente">
