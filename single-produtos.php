...
<div class="fotorama data-thumb" ><br>
  <a href="<?php the_field('imagem'); ?>" data-thumb="<?php the_field('imagem'); ?>" width="110" height="80"></a><br>
  <a href="<?php the_field('imagem1'); ?>" data-thumb="<?php the_field('imagem1'); ?>" width="110" height="80"></a>
  <a href="<?php the_field('imagem2'); ?>" data-thumb="<?php the_field('imagem2'); ?>" width="110" height="80"></a>
  <a href="<?php the_field('imagem3'); ?>" data-thumb="<?php the_field('imagem3'); ?>" width="110" height="80"></a>
  <a href="<?php the_field('imagem4'); ?>" data-thumb="<?php the_field('imagem4'); ?>" width="110" height="80"></a>
...
<script>
  ...
  nav: 'thumbs'
        ...
        <div class="col-xl-6 col-sm-12 col-12">            
            ...
            <h4 id="texto_detalhe"><?php the_field('detalhe_do_produto'); ?></h4>
            
            
            <a href="<?php the_field('downlod_do_catalogo'); ?> " target="_blank"><button class="botao-imagem-gradiente">
...
<section class="container">
    ...
    <div class="row">
        ...
        $product_categories = get_the_terms(get_the_ID(), 'categorias');
