...
<nav id="nav">
    ...
    <section class=" menu-area-azul" >
        ...
        <div class="row col-xl-12">
            ...
            </div class="textoprodutoh"> Mercado - Cozinha 
        </div>
            </div>
...
<section class="container">
     ...
     <div class="container-menus">
        <ul class="text-cente menu-linha">
            ...
            <li><a  href="<?php bloginfo('url'); ?>/cozinha" class="item active">Cozinha</a></li>
...
$(document).ready(function() {
  ...
  $('.item').click(function() {
    ...
    <div class="row">
        ...
        $categoria_slug = 'cozinha'; // Substitua 'nome-da-categoria' pela slug da categoria desejada
