<?php 
// Template Name: geracao-de-espuma
get_header(); ?>
...
<nav id="nav">
    ...
    <section class=" menu-area-azul" > 
        ...
        <div class="row col-xl-12">
            ...
            </div class="textoprodutoh"> Mercado - Gerador de Espuma 
        </div>
            </div>
        
    </section>
<section class="container" id="container-pro">


     <div class="container-menus">
        <ul class="text-cente menu-linha">
            <li><a  href="<?php bloginfo('url'); ?>/alimentos-e-bebidas" >Alimentos e Bebidas</a></li>
            <li><a  href="<?php bloginfo('url'); ?>/cozinha" >Cozinha</a></li>
            <li><a  href="<?php bloginfo('url'); ?>/geracao-de-espuma" class="item active">Geração de Espuma</a></li>
...
$(document).ready(function() {
  ...
  $('.item').click(function() {
    ...
    <div class="row " >
        ...
        $categoria_slug = 'geradores-de-espuma'; // Substitua 'nome-da-categoria' pela slug da categoria desejada

        // Argumentos para a consulta WP_Query
        $args = array(
            'post_type' => 'produtos', // Substitua 'produto' pelo nome do seu tipo de post
            'posts_per_page' => -1, // Exibir todos os posts da categoria
            'tax_query' => array(
                array(
                    'taxonomy' => 'categorias', // Substitua 'categoria' pelo nome da sua taxonomia
                    'field' => 'slug',
