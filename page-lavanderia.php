...
<nav id="nav">
    ...
    <section class=" menu-area-azul" >
        ...
        <div class="row col-xl-12">
            ...
            </div class="textoprodutoh"> Mercado - Lavanderia 
        </div>
            </div>
...
<section class="container">
     ...
     <div class="container-menus">
        <ul class="text-cente menu-linha">
            ...
            <li><a  href="<?php bloginfo('url'); ?>/lavanderia" class="item active">Lavanderia</a></li>
        </ul>
        <script>
$(document).ready(function() {
  ...
  $('.item').click(function() {
    ...
    <div class="row">
        ...
        $categoria_slug = 'lavanderia'; // Substitua 'nome-da-categoria' pela slug da categoria desejada
